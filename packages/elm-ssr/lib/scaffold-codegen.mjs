...
var $author$project$Scaffold$GotRequest = $elm$core$Basics$identity;
...
var $author$project$Scaffold$request = _Platform_incomingPort('request', $elm$json$Json$Decode$value);
var $author$project$Scaffold$GenerateApi = function (a) {
	return {$: 1, a: a};
};
var $author$project$Scaffold$GeneratePage = function (a) {
	return {$: 0, a: a};
};
var $author$project$Scaffold$GenerateResource = function (a) {
	return {$: 2, a: a};
};
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$map = _Json_map1;
var $author$project$Scaffold$RouteSpec = F4(
	function (namespace, moduleName, routePath, parts) {
		return {G: moduleName, w: namespace, J: parts, x: routePath};
	});
var $elm$json$Json$Decode$list = _Json_decodeList;
var $elm$json$Json$Decode$map4 = _Json_map4;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Scaffold$specDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Scaffold$RouteSpec,
	...
	A2($elm$json$Json$Decode$field, 'routePath', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
		'parts',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$string)));
var $author$project$Scaffold$commandDecoder = A2(
	...
	function (kind) {
		return A2(
			...
			function (spec) {
				switch (kind) {
					case 'page':
						return $author$project$Scaffold$GeneratePage(spec);
					case 'api':
						return $author$project$Scaffold$GenerateApi(spec);
					case 'resource':
						return $author$project$Scaffold$GenerateResource(spec);
					default:
						return $author$project$Scaffold$GeneratePage(spec);
				}
			},
			A2($elm$json$Json$Decode$field, 'spec', $author$project$Scaffold$specDecoder));
	},
...
var $author$project$Scaffold$encodeResult = function (content) {
...
var $author$project$Scaffold$response = _Platform_outgoingPort('response', $elm$core$Basics$identity);
var $author$project$Scaffold$generateApi = function (spec) {
	return 'module ' + (spec.w + ('.Routes.' + (spec.G + (' exposing (page, action)\n\nimport ElmSsr.Action as Action exposing (Action)\nimport ElmSsr.Document exposing (Document)\nimport ElmSsr.Loader as Loader exposing (Loader)\nimport ElmSsr.Route exposing (Request)\nimport Json.Encode as Encode\n\npage : Request -> Loader (Document Never)\npage _ =\n    Loader.fail 405 "GET not allowed on this API route"\n\naction : Request -> Action (Document Never)\naction request =\n    -- Process request and return JSON response using Form or custom logic\n    Action.json <|\n        Encode.object\n            [ ( "ok", Encode.bool True )\n            , ( "message", Encode.string "Hello from ' + (spec.x + ' API route!" )\n            ]\n')))));
};
...
var $author$project$Scaffold$update = F2(
	function (msg, _v0) {
		var raw = msg;
		var _v2 = A2($elm$json$Json$Decode$decodeValue, $author$project$Scaffold$commandDecoder, raw);
		if (!_v2.$) {
			var cmd = _v2.a;
			return _Utils_Tuple2(
				0,
				$author$project$Scaffold$response(
					$author$project$Scaffold$encodeResult(
						$author$project$Scaffold$run(cmd))));
		} else {
			var err = _v2.a;
			return _Utils_Tuple2(
				0,
...
var $author$project$Scaffold$main = $elm$core$Platform$worker(
	{
		ay: function (_v0) {
			return _Utils_Tuple2(0, $elm$core$Platform$Cmd$none);
		},
		aE: function (_v1) {
			return $author$project$Scaffold$request($elm$core$Basics$identity);
		},
		aG: $author$project$Scaffold$update
	});
_Platform_export({'Scaffold':{'init':$author$project$Scaffold$main($elm$json$Json$Decode$value)(0)}});}(globalThis));
